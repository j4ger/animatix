...
- `templates/` - starter files for projects and probes.
...
5. Record the workaround and impact in `projects/<name>/notes.md`. This is
   where grammar/feature design feedback should live.
