...
**Refreshed 2026-09-05 (PF-6 rounds 6–10):** the round-5 blocker is resolved —
...
Remaining, ranked: (1) export-path churn — wgpu-internal bookkeeping
(~176 KB/frame on `fft_explain`, not ours) and text recompiles for
genuinely animated content (inherent); (2) `RenderCommand::local_bounds`
...
panels) stay scoped evaluate-lens items; (3) PF-7 GPU/export throughput
(orthogonal second front). PF-2/PF-3 stay paused until the harness
proves stable.
