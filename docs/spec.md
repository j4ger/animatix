...
| Plotting | `ImplicitPlot` | Yes | Runtime-real | Yes | Yes | Shipped implicit contour plotting using a closure `(x, y) => scalar` over the parent graph domain and a grid `resolution`. |
