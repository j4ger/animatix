...
`pub type` aliases are exported by aliased module imports and become available by simple name in the
importing scene, e.g. `Metric` after `import "./types.amx" as types`.
