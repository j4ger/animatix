...
/// Rebuild cached actor labels and per-actor keyframe lists from the timeline.
/// This is a free function to avoid borrow conflicts when called from behavior.rs.
