...
pub fn show_property_popup(
    ...
    let header_content_rect = header_rect.shrink2(Vec2::new(sp.base.space_2, 0.0));
    ...
    content.add_space(header_h + sp.base.space_2);
    // ── Property rows ──
    ...
    let content_rect = Rect::from_min_max(
        content.cursor().min,
        Pos2::new(popup_rect.max.x - sp.base.space_3, popup_rect.max.y - sp.base.space_3),
    );
...
fn popup_property_row(
    ...
    let value_rect = Rect::from_min_size(
        Pos2::new(row_rect.max.x - value_area_width - sp.base.space_2, row_rect.min.y),
