...
impl WorkspaceViewer<'_> {
    ...
    pub(super) fn handle_preview_drag(
        &mut self,
        ui: &mut egui::Ui,
    ...
    pub(super) fn handle_preview_selection(
        &mut self,
        ui: &mut egui::Ui,
        ...
        if response.secondary_clicked() && !is_dragging {
            if let Some(click_pos) = response.interact_pointer_pos() {
                ...
                selection::handle_right_click(
                    ...
                    self.hit_regions,
                    click_pos,
                    move |screen| super::preview_screen_to_scene(scene_dimensions, _preview_rect, screen, zoom, pan),
                );
            }
        }
