//! Raw palette and domain-specific raw colors.
//!
//! # Visibility
//! `pub(crate)` — never import directly from outside this module.
//! All consumption goes through `semantic` or the compatibility facade.
//!
//! # Values
//! Matches the spec (docs/gui_design_language.md). The compatibility facade
//! re-exports old flat names pointing at these underlying values.
...
pub(crate) const CANVAS_BG: Color32 = Color32::from_rgb(8, 8, 12);

/// Diagnostic phase colors.
pub(crate) const DIAG_PARSE: Color32 = Color32::from_rgb(137, 180, 250);
pub(crate) const DIAG_RESOLVE: Color32 = Color32::from_rgb(180, 190, 254);
pub(crate) const DIAG_COMPILE: Color32 = Color32::from_rgb(203, 166, 126);

/// Playing indicator text.
pub(crate) const PLAYING_TEXT_RAW: Color32 = Color32::from_rgb(216, 249, 235);

/// Diagnostic status (non-phase) colors.
pub(crate) const DIAGNOSTIC_RED_RAW: Color32 = Color32::from_rgb(255, 136, 136);
pub(crate) const DIAGNOSTIC_AMBER_RAW: Color32 = Color32::from_rgb(255, 214, 102);

/// Curve editor.
pub(crate) const CURVE_GREEN_RAW: Color32 = Color32::from_rgb(100, 255, 100);
pub(crate) const CURVE_BLUE_RAW: Color32 = Color32::from_rgb(80, 140, 255);
pub(crate) const CURVE_GRAY_RAW: Color32 = Color32::from_rgb(200, 200, 200);

/// Keyframe flash.
pub(crate) const KF_FLASH_RAW: Color32 = Color32::from_rgb(255, 200, 50);

/// Insertion palette snippet highlight.
pub(crate) const SNIPPET_BLUE_RAW: Color32 = Color32::from_rgb(108, 153, 187);
