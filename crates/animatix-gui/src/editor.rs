    ...
    fn refresh_analyzer_diagnostics(&mut self) {
        ...
        for d in analyzer_diagnostics {
            ...
            let severity = match d.severity {
                animatix_analyzer::DiagnosticSeverity::Error => animatix::diagnostics::DiagnosticSeverity::Error,
                animatix_analyzer::DiagnosticSeverity::Warning => animatix::diagnostics::DiagnosticSeverity::Warning,
                animatix_analyzer::DiagnosticSeverity::Info => animatix::diagnostics::DiagnosticSeverity::Warning,
                animatix_analyzer::DiagnosticSeverity::Hint => animatix::diagnostics::DiagnosticSeverity::Warning,
            };
