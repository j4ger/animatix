use gpui::{
    actions, div, fill, hsla, point, prelude::*, px, rgb, rgba, white, App, Bounds, ClipboardItem,
    ...
    Render, ShapedLine, SharedString, Style, TextRun, UTF16Selection, Window,
};
use std::ops::Range;
...
impl TextInput {
    ...
    pub fn set_value(
        ...
        cx.emit(TextInputEvent::Change(self.content.to_string()));
        cx.notify();
    }
