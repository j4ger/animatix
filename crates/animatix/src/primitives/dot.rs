...
impl Primitive for DotPrimitive {
    fn type_name(&self) -> &'static str { "Dot" }
    fn display_name(&self) -> &'static str { "Dot" }
    fn category(&self) -> ActorCategory { ActorCategory::Shape }
    fn icon_id(&self) -> &'static str { "dot" }
    ...
    fn default_props(&self, _scene: &SceneDimensions) -> Vec<Property> {
        vec![
            ...
            Property { name: "size".into(), value: Expr::Tuple(vec![Expr::Num(6.0), Expr::Num(6.0)]), value_span: None, trailing_comment: None },
