...
pub static PROPERTY_REGISTRY: &[PropertySchema] = &[
    ...
    schema!("arc_angles",    ValueType::Vec2,        F::ASSIGNABLE_A,              ActorField::ArcAngles,           Some(GroupMembership { group_id: GroupHandlerId::VectorShapeState }), Applicable::Never, |_| super::property_engine::PropertyValue::Vec2([0.0, std::f32::consts::PI])),
    ...
    schema!("radius",        ValueType::F32,         F::ASSIGNABLE_AI,             ActorField::Size,                Some(GroupMembership { group_id: GroupHandlerId::VectorShapeState }), Applicable::ShapeKinds(&[S::Circle, S::Dot, S::RegularPolygon]), |_| super::property_engine::PropertyValue::F32(50.0)),
    schema!("radius_x",      ValueType::F32,         F::ASSIGNABLE_AI,             ActorField::Size,                Some(GroupMembership { group_id: GroupHandlerId::VectorShapeState }), Applicable::ShapeKinds(&[S::Ellipse, S::Arc]), |_| super::property_engine::PropertyValue::F32(50.0)),
    schema!("radius_y",      ValueType::F32,         F::ASSIGNABLE_AI,             ActorField::Size,                Some(GroupMembership { group_id: GroupHandlerId::VectorShapeState }), Applicable::ShapeKinds(&[S::Ellipse, S::Arc]), |_| super::property_engine::PropertyValue::F32(50.0)),
    ...
    schema!("sides",         ValueType::U32,         F::empty(),                   ActorField::VectorShapeGroup,    Some(GroupMembership { group_id: GroupHandlerId::VectorShapeState }), Applicable::Never, |_| super::property_engine::PropertyValue::U32(3)),
    ...
    schema!("start_angle",   ValueType::F32,         F::ASSIGNABLE_AI,             ActorField::ArcAngles,           Some(GroupMembership { group_id: GroupHandlerId::VectorShapeState }), Applicable::ShapeKinds(&[S::Arc]), |_| super::property_engine::PropertyValue::F32(0.0)),
    ...
    schema!("sweep_angle",   ValueType::F32,         F::ASSIGNABLE_AI,             ActorField::ArcAngles,           Some(GroupMembership { group_id: GroupHandlerId::VectorShapeState }), Applicable::ShapeKinds(&[S::Arc]), |_| super::property_engine::PropertyValue::F32(std::f32::consts::PI)),
    ...
    schema!("tip_length",    ValueType::F32,         F::empty(),                   ActorField::VectorShapeGroup,    Some(GroupMembership { group_id: GroupHandlerId::VectorShapeState }), Applicable::ShapeKinds(&[S::Arrow]), |_| super::property_engine::PropertyValue::F32(10.0)),
    schema!("tip_width",     ValueType::F32,         F::empty(),                   ActorField::VectorShapeGroup,    Some(GroupMembership { group_id: GroupHandlerId::VectorShapeState }), Applicable::ShapeKinds(&[S::Arrow]), |_| super::property_engine::PropertyValue::F32(10.0)),
