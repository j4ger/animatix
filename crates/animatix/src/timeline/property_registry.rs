...
pub static PROPERTY_REGISTRY: &[PropertySchema] = &[
    ...
    PropertySchema { name: "points",       value_type: ValueType::PointList,  flags: F::ASSIGNABLE_A,             field: ActorField::Points,             group: Some(GroupMembership { group_id: GroupHandlerId::VectorShapeState }), applicable: Applicable::ShapeKinds(&[S::Polygon]) },
