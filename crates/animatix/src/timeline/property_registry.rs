    ...
    pub fn includes(self, kind: super::ActorKindId) -> bool {
        ...
        match self {
            ...
            Applicable::SizedActors => {
                matches!(kind, Shape(_) | Image | Graph | PlotCurve | Row | Col | Grid | Stack)
            }
...
pub static PROPERTY_REGISTRY: &[PropertySchema] = &[
    ...
    schema!("func",          ValueType::BuildTimeOnly, F::empty(),                 ActorField::PlotDomainGroup,     Some(GroupMembership { group_id: GroupHandlerId::PlotDomain }), Applicable::ActorKinds(&[A::PlotCurve]), |_| super::property_engine::PropertyValue::String(String::new())),
    ...
    schema!("max_depth",     ValueType::F32,         F::empty(),                   ActorField::PlotDomainGroup,     Some(GroupMembership { group_id: GroupHandlerId::PlotDomain }), Applicable::ActorKinds(&[A::PlotCurve]), |_| super::property_engine::PropertyValue::F32(100.0)),
    ...
    schema!("resolution",    ValueType::F32,         F::empty(),                   ActorField::PlotDomainGroup,     Some(GroupMembership { group_id: GroupHandlerId::PlotDomain }), Applicable::ActorKinds(&[A::PlotCurve]), |_| super::property_engine::PropertyValue::F32(100.0)),
    ...
    schema!("x_domain",      ValueType::Vec2,        F::empty(),                   ActorField::PlotDomainGroup,     Some(GroupMembership { group_id: GroupHandlerId::PlotDomain }), Applicable::ActorKinds(&[A::Graph, A::PlotCurve]), |_| super::property_engine::PropertyValue::Vec2([-5.0, 5.0])),
    schema!("y_domain",      ValueType::Vec2,        F::empty(),                   ActorField::PlotDomainGroup,     Some(GroupMembership { group_id: GroupHandlerId::PlotDomain }), Applicable::ActorKinds(&[A::Graph, A::PlotCurve]), |_| super::property_engine::PropertyValue::Vec2([-5.0, 5.0])),
];
