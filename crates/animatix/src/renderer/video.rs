...
//! - [`super::encode`] — `ExportError`, `ExportSettings`, `MaxRenderThreads`,
//!   `VideoCodec`, `H264Preset`, and format-specific encoding functions
...
pub use super::encode::{
    ...
    render_gif_timeline, render_gif_timeline_with_debug,
    ...
    render_video_timeline_with_progress, render_video_timeline_with_settings,
};
