...
fn raw_property_specs() -> Vec<(&'static str, &'static [&'static str], Type, PropertyValueKind)> {
    let mut specs: Vec<(&'static str, &'static [&'static str], Type, PropertyValueKind)> = vec![
        ...
        (
            "gap",
            &["Row", "Col", "Grid", "Stack", "Group", "Mask", "Legend"],
            Type::Num,
            PropertyValueKind::F32,
        ),
        ...
        ("levels", &["ContourSet"], Type::Any, PropertyValueKind::Vec2),
        (
            "line_cap",
        ...
        ("show_axis", &["BarChart"], Type::Bool, PropertyValueKind::Generic),
        ("show_labels", &["BarChart"], Type::Bool, PropertyValueKind::Generic),
        (
            "size",
            &[
                "Rect",
